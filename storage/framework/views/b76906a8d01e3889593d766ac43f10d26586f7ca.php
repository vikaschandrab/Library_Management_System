                              ...
                              <?php if(count($booksList) != 0): ?>
                                  ...
                                  <?php $__currentLoopData = $booksList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $books): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr>
                                            ...
                                            <td><?php echo e($books->borrowed_books); ?></td>
                                            <td><?php echo e($books->book_code); ?></td>
                                            <?php if($books->status == 1): ?>
                                                <td><a href="#open-modal-editactive-<?php echo e($books->booksId); ?>" class="badge badge-success">Active</a></td>
                                            <?php else: ?>
                                                <td><a href="#open-modal-editactive-<?php echo e($books->booksId); ?>" class="badge badge-danger">Inactive</a></td>
                                            <?php endif; ?>
                                      </tr>
                                      <?php $i++ ?>
...
<?php $__currentLoopData = $booksList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $books): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <form action="/admin/addbooks" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div id="open-modal-editactive-<?php echo e($books->booksId); ?>" class="modal-window">
            <div>
                ...
                <div class="input-field-pop">
                    <div class="white_box mb_30">
                        ...
                        <input type="hidden" id="id" name="id" value="<?php echo e($books->booksId); ?>">
                    </div>
                </div> <br>
...
<?php /**PATH G:\nxtGIO projects\EWDP\LMS_Web\Library_Management_System\resources\views/Admin/books.blade.php ENDPATH**/ ?>