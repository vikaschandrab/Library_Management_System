              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body" onclick="mybook()">
                    ...
                    <h4 class="font-weight-normal mb-3">Borrow New Books<i class="float-right"><?php echo e($countBooks); ?></i>
                    </h4>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body" onclick="myrequestlist()">
                    <img src="../images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Return Request List<i class="float-right"><?php echo e($countReturnRequest); ?></i>
                    </h4>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body" onclick="myretunbooks()">
                    <img src="../images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Return Books<i class="float-right"><?php echo e($countReturnBooks); ?></i>
                    </h4>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body" onclick="myrequestedbooks()">
                    <img src="../images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Requested Books<i class="float-right"><?php echo e($countRequestedBooks); ?></i>
                    </h4>
                  </div>
                </div>
              </div>
                            ...
                            <?php if(count($getBooks) != null): ?>
                                ...
                                <?php $__currentLoopData = $getBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $books): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($books -> remaining_books); ?></td>
                                        <td><?php echo e($books -> book_code); ?></td>
                                        <td>
                                            <a href="#open-modal-editactive-<?php echo e($books -> book_code); ?>" class="status_btn">Borrow</a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <table class="table table-responsive">
                        ...
                        <tbody>
                            <?php if(count($ReturnRequest) == null): ?>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                            ...
                            <?php else: ?>
                            <?php $i = 1 ?>
                                <?php $__currentLoopData = $ReturnRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        ...
                                        <td>
                                            <a href="#open-modal-editrequest-<?php echo e($list -> booksborrowId); ?>" class="status_btn">Return</a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card-body">
                      <table class="table table-responsive">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                            <?php $i = 1 ?>
                                <?php $__currentLoopData = $ReturnBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $books): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td class=" text-wrap"><?php echo e($books -> publication); ?></td>
                                        <td><?php echo e($books -> author); ?></td>
                                        ...
                                        <td>
                                            <a href="#open-modal-returnbook-<?php echo e($books -> booksborrowId); ?>" class="status_btn">Return</a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <table class="table table-responsive">
                        ...
                        <tbody>
                            <?php if(count($requestedBooks) == null): ?>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                            ...
                            <?php else: ?>
                                <?php $i=1; ?>
                                <?php $__currentLoopData = $requestedBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $books): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td class=" text-wrap"><?php echo e($books -> publication); ?></td>
                                        <td><?php echo e($books -> author); ?></td>
                                        <td class=" text-wrap"><?php echo e($books -> title); ?></td>
                                        <td><?php echo e($books -> book_code); ?></td>
                                        <?php if($books -> isAccepted == '0'): ?>
                                            <td>Rejected</td>
                                        <?php elseif($books -> isAccepted == 1): ?>
                                            <td>Accepted</td>
                                        <?php elseif($books -> isAccepted == null): ?>
...
<form action="/student/bookRequest" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div id="open-modal-editactive-<?php echo e($books -> book_code); ?>" class="modal-window">
        <div>
            ...
            <div class="input-field-pop">
                ...
                <input type="hidden" id="book_code" name="book_code" value="<?php echo e($books -> book_code); ?>">
            </div> <br>
...
<?php $__currentLoopData = $ReturnRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <form action="/student/bookRequest" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div id="open-modal-editrequest-<?php echo e($list -> booksborrowId); ?>" class="modal-window">
            <div>
                <div class="input-field-pop">
                    <div class="white_box mb_30">
                        <div class="box_header ">
                    ...
                    <input type="hidden" name="id" id="id" value="<?php echo e($list -> booksborrowId); ?>">
                </div> <br>
...
<?php $__currentLoopData = $ReturnBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $books): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <form action="/student/bookRequest" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div id="open-modal-returnbook-<?php echo e($books -> booksborrowId); ?>" class="modal-window">
            <div>
                <div class="input-field-pop">
                    <div class="white_box mb_30">
                        <div class="box_header ">
                    ...
                    <input type="hidden" id="id" name="id" value="<?php echo e($books -> booksborrowId); ?>">
                </div> <br>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        <?php if(session('failure')): ?>
            swal({
            title: ' <?php echo e(session('failure')); ?>',
            icon: "error",
            button: "Done",
            });
        <?php endif; ?>
...
<?php /**PATH G:\nxtGIO projects\EWDP\LMS_Web\Library_Management_System\resources\views/Student/borrowbook.blade.php ENDPATH**/ ?>