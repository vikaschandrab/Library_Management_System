            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                    @if ($getProfile->profilePicture == null)
                        <img src="../images/profile.png" alt="image">
                    @else
                        <img src="../images/librarian/{{ $getProfile->profilePicture }}" alt="image">
                    @endif
                ...
                <div class="card">
                  <div class="card-body">
                    <form class="forms-sample" method="post" action="/librarian/profileupdate" enctype="multipart/form-data">
                        ...
                        @else
                            <img src="../images/librarian/{{ $getProfile->profilePicture }}" alt="image" width="100px" height="100px" class="imagecenter">
                        @endif
                        <div class="form-group" style="padding-top:15px;">
                            <label for="exampleInputUsername1">Name</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" name="name" value="{{ $getProfile->name }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Email</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" name="email" value="{{ $getProfile->email }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Mobile</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="phone" value="{{ $getProfile->phone }}">
                        </div>
                        <div class="form-group">
                            <label>Photo upload</label>
                            <input type="file" name="img" class="file-upload-default">
                            <div class="input-group col-xs-12">
                            <input type="text" class="form-control file-upload-info  @error('img') is-invalid @enderror" disabled placeholder="{{ $getProfile->profilePicture }}">
