              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body" onclick="myborrow()">
                    ...
                    <h4 class="font-weight-normal mb-3">Borrowed Books<i class="float-right">{{ $countBorrowedBooks }}</i>
                    </h4>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body" onclick="mydue()">
                    <img src="../images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Due Books<i class="float-right">{{ $countDueBooks }}</i>
                    </h4>
                  </div>
                </div>
              </div>
