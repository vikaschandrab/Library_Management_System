                          ...
                          @if (count($booksList) != null)
                              ...
                              @foreach ($booksList as $books)
                                  <tr>
                                        ...
                                        <td>{{ $books->remaining_books }}
                                            <div class="progress">
                                                <div class="progress-bar bg-success" role="progressbar" style="width: {{ $books->remaining_books }}%" aria-valuenow="{{ $books->remaining_books }}" aria-valuemin="0" aria-valuemax="{{ $books->total_books }}"></div>
                                            </div>
                                        </td>
                                        <td>{{ $books->borrowed_books }}
                                            <div class="progress">
                                                <div class="progress-bar bg-success" role="progressbar" style="width: {{ $books->borrowed_books }}%" aria-valuenow="{{ $books->borrowed_books }}" aria-valuemin="0" aria-valuemax="{{ $books->total_books }}"></div>
                                            </div>
                                        </td>
