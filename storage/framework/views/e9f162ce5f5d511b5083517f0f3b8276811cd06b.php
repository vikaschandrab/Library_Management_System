              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body" onclick="mystudent()">
                    ...
                    <h4 class="font-weight-normal mb-3">Departments <i class="float-right"><?php echo e($getDepartmentsCount); ?></i>
                    </h4>
                  </div>
                </div>
              </div>
                 ...
                 <div class="card">
                   <div class="card-body">
                     <table class="table">
                       ...
                       <tbody>
                           <?php $i =1 ?>
                           <?php if(count($getDepartments) == null): ?>
                            <tr>
                                <td></td>
                                <td>No Departments Added</td>
                            </tr>
                           <?php else: ?>
                            <?php $__currentLoopData = $getDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo $i ?></td>
...
<?php /**PATH G:\nxtGIO projects\EWDP\LMS_Web\Library_Management_System\resources\views/Admin/department.blade.php ENDPATH**/ ?>